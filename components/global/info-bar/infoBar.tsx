...
import { FileVideoCameraIcon, Search, UploadCloudIcon } from 'lucide-react'
import React from 'react'


const InfoBar = () => {
  return (
    <header className='pl-[80px] md:pl-[265px] fixed p-4 w-full flex items-center justify-between gap-4'>
